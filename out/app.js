...
var App = /** @class */ (function () {
    ...
    App.prototype.initializeMiddlewares = function () {
        ...
        this.app.use(cors({
            origin: [environment_1.env.CLIENT_URL, environment_1.env.IP_URL],
            credentials: true
        }));
        ...
        this.app.use(session({
            name: environment_1.env.SESSION_NAME,
            resave: false,
            secret: environment_1.env.SESSION_SECRET,
            saveUninitialized: false,
            cookie: {
                maxAge: environment_1.env.MAX_AGE,
                sameSite: true,
    ...
    App.prototype.start = function () {
        ...
        this.server.on("listening", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, mongoHelper_1.MongoHelper.connect(environment_1.env.MONGO_URI)];
                    case 2:
                        _a.sent();
